...
def setup_arguments(args=None):
    ...
    parser.add_argument("--use_reward_to_go", "-rtg", action="store_true", default=True)
    parser.add_argument("--use_baseline", action="store_true", default=True)
    parser.add_argument("--baseline_learning_rate", "-blr", type=float, default=0.01)
    ...
    parser.add_argument(
        "--normalize_advantages", "-na", action="store_true", default=False
    )
    parser.add_argument(
